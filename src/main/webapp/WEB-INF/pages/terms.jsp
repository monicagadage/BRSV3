...
<html>
<head>
<title>Green Wheels a Bus Booking Service | Terms :: w3layouts</title>
...
<div class="banner-1">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Green Wheels - Best in Class Bus Booking Service</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- terms ---->
